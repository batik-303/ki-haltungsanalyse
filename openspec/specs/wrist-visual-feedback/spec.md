...
The sapphire anchor SHALL emit a golden flash when the 5-second challenge timer fires a success event (railSuccessGlow > 0).

#### Scenario: Timer success triggers flash
